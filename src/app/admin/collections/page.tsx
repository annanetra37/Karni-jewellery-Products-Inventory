  ...
  return (
    <div className="space-y-4">
      ...
      <header>
        ...
        <p className="page-subtitle">Set the photo and the Armenian / Russian names for each collection. The translated name is shown when the app language is switched.</p>
      </header>
              ...
              <form action={saveAction} className="space-y-3">
                ...
                <div className="grid sm:grid-cols-2 gap-2">
                  <div>
                    ...
                    <input className="input" name="nameHy" defaultValue={m?.nameHy || ''} placeholder="Հայերեն անվանում" />
                  </div>
                  <div>
                    <label className="label">Russian name</label>
                    <input className="input" name="nameRu" defaultValue={m?.nameRu || ''} placeholder="Русское название" />
                  </div>
                </div>

...
const D: Record<string, Record<Locale, string>> = {
  ...
  'sf.asOf': { en: 'as of {date}', hy: '{date} դրությամբ', ru: 'на {date}' },
  'sf.balanceAsOf': { en: 'Balances as of {date}', hy: 'Մնացորդներ {date} դրությամբ', ru: 'Балансы на {date}' },
  'sf.allTime': { en: 'all time', hy: 'ամբողջ ընթացքում', ru: 'за всё время' },
  ...
  's.modeStore': { en: 'In-store sale', hy: 'Խանութի վաճառք', ru: 'Продажа в магазине' },
  ...
  's.onlineHint': { en: 'Not counted toward your sales. The purchase amount is booked to the safe from the online source (not the drawer); add any delivery cash you took from the drawer below.', hy: 'Չի հաշվվում ձեր վաճառքներում։ Գնման գումարը գրանցվում է սեյֆում առցանց աղբյուրից (ոչ դրամարկղից)․ ստորև ավելացրեք դրամարկղից վերցված առաքման կանխիկը։', ru: 'Не засчитывается в ваши продажи. Сумма покупки заносится в сейф из онлайн-источника (не из кассы); ниже добавьте наличные на доставку, взятые из кассы.' },
  's.onlineSource': { en: 'Online source', hy: 'Առցանց աղբյուր', ru: 'Онлайн-источник' },
  's.onlineSourceHint': { en: 'Where the order came from — the purchase amount is deposited to the safe from here (not from a drawer).', hy: 'Որտեղից է պատվերը — գնման գումարը մուտքագրվում է սեյֆ այստեղից (ոչ դրամարկղից)։', ru: 'Откуда пришёл заказ — сумма покупки зачисляется в сейф отсюда (не из кассы).' },
  's.deliveryFromDrawer': { en: 'Delivery cash taken from the drawer', hy: 'Դրամարկղից վերցված առաքման կանխիկ', ru: 'Наличные на доставку, взятые из кассы' },
  's.deliveryFromDrawerHint': { en: 'Optional. Recorded as drawer→safe and a shared delivery expense.', hy: 'Ըստ ցանկության։ Գրանցվում է որպես դրամարկղ→սեյֆ և ընդհանուր առաքման ծախս։', ru: 'Необязательно. Записывается как касса→сейф и общий расход на доставку.' },
  's.deliveryNote': { en: 'Which order / for whom?', hy: 'Ո՞ր պատվերի / ու՞մ համար', ru: 'Для какого заказа / кого?' },
  's.confirmOnline': { en: 'Record online sale', hy: 'Գրանցել առցանց վաճառք', ru: 'Записать онлайн-продажу' },
  ...
  'pr.state': { en: 'State', hy: 'Վիճակ', ru: 'Состояние' },
  'pr.low': { en: 'Low', hy: 'Քիչ է', ru: 'Мало' },
  'pr.allStates': { en: 'All states', hy: 'Բոլոր վիճակները', ru: 'Все состояния' },
  'sm.stockAll': { en: 'All stock', hy: 'Ամբողջ պաշարը', ru: 'Весь остаток' },
  'sm.inStock': { en: 'In stock', hy: 'Առկա է', ru: 'В наличии' },
  'sm.outOfStock': { en: 'Out of stock', hy: 'Առկա չէ', ru: 'Нет в наличии' },
  'sm.nowOut': { en: 'out of stock', hy: 'առկա չէ', ru: 'нет в наличии' },
  'sm.nowIn': { en: 'in stock', hy: 'պահեստում', ru: 'в наличии' },
  ...
  'k.deliveryCash': { en: 'Cash taken for a delivery', hy: 'Առաքման համար վերցված կանխիկ', ru: 'Наличные, взятые на доставку' },
  'k.deliveryAmount': { en: 'Amount taken from the drawer', hy: 'Դրամարկղից վերցված գումարը', ru: 'Сумма, взятая из кассы' },
  'k.deliveryNote': { en: 'Which order / delivery?', hy: 'Ո՞ր պատվերի / առաքման համար', ru: 'Для какого заказа / доставки?' },
  'k.recordDelivery': { en: 'Record delivery cash', hy: 'Գրանցել առաքման կանխիկը', ru: 'Записать наличные на доставку' },
  'k.deliveryHint': { en: 'Moves this cash from the drawer to the safe and logs it as a delivery expense (Investment). Your drawer count drops by this amount.', hy: 'Այս կանխիկը դրամարկղից տեղափոխում է սեյֆ և գրանցում որպես առաքման ծախս (ներդրում)։ Ձեր դրամարկղի մնացորդը նվազում է այս չափով։', ru: 'Переносит эти наличные из кассы в сейф и записывает как расход на доставку (инвестиция). Остаток вашей кассы уменьшается на эту сумму.' },
  ...
  'sa.asOf': { en: 'as of {date}', hy: '{date} դրությամբ', ru: 'на {date}' },
  'sa.businessMetrics': { en: 'Key business metrics', hy: 'Հիմնական բիզնես ցուցանիշներ', ru: 'Ключевые бизнес-метрики' },
  'sa.businessHint': { en: 'Tap any metric to see what’s behind it.', hy: 'Սեղմեք ցուցանիշը՝ մանրամասների համար։', ru: 'Нажмите метрику, чтобы увидеть детали.' },
  'sa.growth': { en: 'Revenue growth', hy: 'Հասույթի աճ', ru: 'Рост выручки' },
  'sa.vsPrev': { en: 'vs previous {n}', hy: 'նախորդ {n}-ի համեմատ', ru: 'к предыдущим {n}' },
  'sa.growthNA': { en: 'pick a date range', hy: 'ընտրեք ժամկետ', ru: 'выберите период' },
  'sa.thisPeriod': { en: 'This period', hy: 'Այս ժամանակահատված', ru: 'Этот период' },
  'sa.prevPeriod': { en: 'Previous period', hy: 'Նախորդ ժամանակահատված', ru: 'Предыдущий период' },
  'sa.grossProfit': { en: 'Gross profit', hy: 'Համախառն շահույթ', ru: 'Валовая прибыль' },
  'sa.marginSub': { en: '{margin}% margin · {cov}% costed', hy: '{margin}% մարժա · {cov}% ինքնարժեքով', ru: '{margin}% маржа · {cov}% с себестоимостью' },
  'sa.noCost': { en: 'no cost data yet', hy: 'ինքնարժեքի տվյալ չկա', ru: 'нет данных о себестоимости' },
  'sa.returnRate': { en: 'Return rate', hy: 'Վերադարձի տոկոս', ru: 'Доля возвратов' },
  'sa.returnRateSub': { en: '{n} returns · {share}% of revenue', hy: '{n} վերադարձ · հասույթի {share}%', ru: '{n} возвратов · {share}% выручки' },
  'sa.discountRate': { en: 'Discount rate', hy: 'Զեղչի տոկոս', ru: 'Доля скидок' },
  'sa.discountRateSub': { en: '{amount} off subtotal', hy: '{amount} ենթագումարից', ru: '{amount} от подытога' },
  'sa.salesPerDay': { en: 'Sales per day', hy: 'Վաճառք օրական', ru: 'Продаж в день' },
  'sa.salesPerDaySub': { en: '{units} units/day', hy: '{units} միավոր/օր', ru: '{units} ед./день' },
  'sa.bestDay': { en: 'Best day', hy: 'Լավագույն օր', ru: 'Лучший день' },
  'sa.rollingAvg': { en: '7-day average', hy: '7-օրյա միջին', ru: 'Среднее за 7 дней' },
  'sa.dailyRevenue': { en: 'Daily revenue', hy: 'Օրական հասույթ', ru: 'Выручка за день' },
  'sa.activeHours': { en: 'Active hours by weekday', hy: 'Ակտիվ ժամերն ըստ շաբաթվա օրերի', ru: 'Активные часы по дням недели' },
  'sa.activeHoursHint': { en: 'The typical busy window and busiest hour each weekday, in Yerevan time (10am–10pm).', hy: 'Տիպիկ զբաղված պատուհանն ու ամենազբաղված ժամը յուրաքանչյուր օր՝ Երևանյան ժամանակով (10:00–22:00)։', ru: 'Типичное окно загруженности и самый загруженный час по дням недели, ереванское время (10:00–22:00).' },
  'sa.hoursUnit': { en: 'h', hy: 'ժ', ru: 'ч' },
  'sa.growthTrends': { en: 'Growth trends', hy: 'Աճի միտումներ', ru: 'Тренды роста' },
  'sa.trendNote': { en: 'Trailing 12 periods · not affected by the date filter', hy: 'Վերջին 12 ժամանակահատված · կախված չէ ամսաթվի զտիչից', ru: 'Последние 12 периодов · не зависит от фильтра дат' },
  'sa.monthOnMonth': { en: 'Month on month', hy: 'Ամսից ամիս', ru: 'Месяц к месяцу' },
  'sa.weekOnWeek': { en: 'Week on week', hy: 'Շաբաթից շաբաթ', ru: 'Неделя к неделе' },
  'sa.vsPrevMonth': { en: 'vs last month', hy: 'նախորդ ամսվա համեմատ', ru: 'к прошлому месяцу' },
  'sa.vsPrevWeek': { en: 'vs last week', hy: 'նախորդ շաբաթվա համեմատ', ru: 'к прошлой неделе' },
  'sa.notEnough': { en: 'not enough history', hy: 'պատմությունը քիչ է', ru: 'мало данных' },
  'sa.howCalculated': { en: 'How it’s calculated', hy: 'Ինչպես է հաշվարկվում', ru: 'Как рассчитано' },
  'sa.momInfo': {
    en: 'Month on month compares each calendar month’s total sales to the month before it.\n\nGrowth % = (this month − last month) ÷ last month × 100.\n\n• Bars = total sales for the month (gross real sales, exchanges excluded).\n• Line = growth vs the previous month.\n• Months are Yerevan calendar months; the newest one is still in progress.\n• Covers the last 12 months. It ignores the date filter above (a trend needs history) but respects the point / salesperson / payment filters.',
    hy: 'Ամսից ամիս համեմատում է յուրաքանչյուր օրացուցային ամսվա ընդհանուր վաճառքը նախորդ ամսվա հետ։\n\nԱճ % = (այս ամիս − նախորդ ամիս) ÷ նախորդ ամիս × 100։\n\n• Սյուները = ամսվա ընդհանուր վաճառք (զուտ իրական վաճառք, փոխանակումները բացառված)։\n• Գիծը = աճը նախորդ ամսվա համեմատ։\n• Ամիսները Երևանյան օրացուցային են; վերջինը դեռ ընթացքի մեջ է։\n• Ընդգրկում է վերջին 12 ամիսը։ Անտեսում է վերևի ամսաթվի զտիչը, բայց հաշվի է առնում կետ / վաճառող / վճարման զտիչները։',
    ru: 'Месяц к месяцу сравнивает общие продажи каждого календарного месяца с предыдущим.\n\nРост % = (этот месяц − прошлый месяц) ÷ прошлый месяц × 100.\n\n• Столбцы = продажи за месяц (валовые реальные продажи, обмены исключены).\n• Линия = рост к предыдущему месяцу.\n• Месяцы — ереванские календарные; последний ещё не завершён.\n• За последние 12 месяцев. Не зависит от фильтра дат выше, но учитывает точку / продавца / способ оплаты.',
  },
  'sa.wowInfo': {
    en: 'Week on week compares each week’s total sales to the week before it.\n\nGrowth % = (this week − last week) ÷ last week × 100.\n\n• Bars = total sales for the week (gross real sales, exchanges excluded).\n• Line = growth vs the previous week.\n• Weeks start on Monday (Yerevan) and are labelled by that Monday’s date.\n• Covers the last 12 weeks. It ignores the date filter above but respects the point / salesperson / payment filters.',
    hy: 'Շաբաթից շաբաթ համեմատում է յուրաքանչյուր շաբաթվա ընդհանուր վաճառքը նախորդ շաբաթվա հետ։\n\nԱճ % = (այս շաբաթ − նախորդ շաբաթ) ÷ նախորդ շաբաթ × 100։\n\n• Սյուները = շաբաթվա ընդհանուր վաճառք (զուտ իրական վաճառք, փոխանակումները բացառված)։\n• Գիծը = աճը նախորդ շաբաթվա համեմատ։\n• Շաբաթները սկսվում են երկուշաբթի (Երևան) և նշվում են այդ երկուշաբթվա ամսաթվով։\n• Ընդգրկում է վերջին 12 շաբաթը։ Անտեսում է վերևի ամսաթվի զտիչը, բայց հաշվի է առնում կետ / վաճառող / վճարման զտիչները։',
    ru: 'Неделя к неделе сравнивает общие продажи каждой недели с предыдущей.\n\nРост % = (эта неделя − прошлая неделя) ÷ прошлая неделя × 100.\n\n• Столбцы = продажи за неделю (валовые реальные продажи, обмены исключены).\n• Линия = рост к предыдущей неделе.\n• Недели начинаются в понедельник (Ереван) и обозначаются датой этого понедельника.\n• За последние 12 недель. Не зависит от фильтра дат выше, но учитывает точку / продавца / способ оплаты.',
  },
  'sa.activeHoursInfo': {
    en: 'When the shop is actively selling, weekday by weekday, in Yerevan time.\n\nThe vertical axis is fixed to working hours 10am–10pm with 3-hour marks, so every weekday is read on the same scale.\n\n• The shaded band spans the typical first sale → last sale hour for that weekday: for each day we take the earliest and latest hour with a sale, then average those across all the days of that weekday in the selected range.\n• The dashed line + dot mark the busiest hour — the single clock-hour with the most sales on that weekday.\n• Anything before 10am or after 10pm is clamped into the 10am–10pm window.\n• Hover a weekday to see its open–close window, busiest hour and average active hours.\n• Uses the date / point / salesperson filters above.',
    hy: 'Երբ է խանութը ակտիվ վաճառում՝ ըստ շաբաթվա օրերի, Երևանյան ժամանակով։\n\nՈւղղահայաց առանցքը ֆիքսված է աշխատանքային ժամերին՝ 10:00–22:00, 3-ժամյա նշումներով, որպեսզի բոլոր օրերը կարդացվեն նույն սանդղակով։\n\n• Ստվերապատ գոտին ընդգրկում է տվյալ օրվա սովորական առաջին → վերջին վաճառքի ժամը. յուրաքանչյուր օրվա համար վերցնում ենք վաճառքով ամենավաղ և ամենաուշ ժամը, ապա միջինացնում ընտրված ժամկետի այդ շաբաթվա օրերով։\n• Կետագիծն ու կետը նշում են ամենազբաղված ժամը՝ ամենաշատ վաճառքով ժամը այդ օրվա համար։\n• 10:00-ից առաջ կամ 22:00-ից հետո ամեն ինչ սահմանափակվում է 10:00–22:00 պատուհանում։\n• Սահեցրեք օրվա վրա՝ տեսնելու բացման–փակման պատուհանը, ամենազբաղված ժամը և ակտիվ ժամերի միջինը։\n• Օգտագործում է վերևի ամսաթիվ / կետ / վաճառող զտիչները։',
    ru: 'Когда магазин активно продаёт, по дням недели, по ереванскому времени.\n\nВертикальная ось зафиксирована на рабочих часах 10:00–22:00 с 3-часовыми отметками, чтобы все дни читались в одном масштабе.\n\n• Затенённая полоса охватывает типичный час первой → последней продажи для этого дня: для каждого дня берём самый ранний и самый поздний час с продажей, затем усредняем по всем дням этой недели в выбранном диапазоне.\n• Пунктирная линия и точка отмечают самый загруженный час — час с наибольшим числом продаж в этот день недели.\n• Всё до 10:00 и после 22:00 ограничивается окном 10:00–22:00.\n• Наведите на день недели, чтобы увидеть окно открытия–закрытия, самый загруженный час и среднее число активных часов.\n• Использует фильтры даты / точки / продавца выше.',
  },
  ...
  'sa.safeNote': { en: 'Balance is the total in the safe as of the end of the selected period; Into / Out cover the period itself. Company-wide.', hy: 'Մնացորդը սեյֆի ընդհանուրն է ընտրված ժամանակահատվածի վերջի դրությամբ, Ներս/Դուրս՝ հենց ժամանակահատվածի համար։ Ընկերության ընդհանուր։', ru: 'Баланс — сумма в сейфе на конец выбранного периода; Вход/Выход — за сам период. По всей компании.' },
  'sa.cardInBank': { en: 'Card at POS now', hy: 'Քարտի մնացորդ POS-ում', ru: 'На POS сейчас' },
  'sa.cardTrackingNote': { en: 'Card sales and POS → safe cover the selected period; Card at POS is the running balance as of the end of the period (all card sales minus all moved to the safe, up to that date). Company-wide.', hy: 'Քարտով վաճառքը և POS → սեյֆը ընտրված ժամանակահատվածի համար են, Քարտի մնացորդը POS-ում ընթացիկ մնացորդն է ժամանակահատվածի վերջի դրությամբ (բոլոր քարտային վաճառքները հանած սեյֆ տեղափոխվածը՝ մինչ այդ ամսաթիվը)։ Ընկերության ընդհանուր։', ru: 'Продажи картой и POS → сейф — за выбранный период; На POS — баланс на конец периода (все продажи картой минус перемещённое в сейф до этой даты). По всей компании.' },

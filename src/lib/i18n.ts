...
const D: Record<string, Record<Locale, string>> = {
  ...
  'sf.sourceBank': { en: 'Card money from the bank', hy: 'Քարտի գումար բանկից', ru: 'Деньги с карты из банка' },
  'sf.bankToSafe': { en: 'Bank → safe', hy: 'Բանկ → սեյֆ', ru: 'Банк → сейф' },
  'sf.fromBank': { en: 'Card money from the bank', hy: 'Քարտի գումար բանկից', ru: 'Деньги с карты из банка' },
  'sf.bankInflowNote': { en: 'Includes {amount} moved from the bank (card revenue).', hy: 'Ներառում է բանկից տեղափոխված {amount} (քարտային մուտքեր)։', ru: 'Включает {amount}, перемещённые из банка (выручка по картам).' },
  ...
  's.nonDrawerHint': { en: 'For a part-cash sale — e.g. the customer paid the rest by transfer or it went straight to the safe. Excluded from the drawer; the total is unchanged.', hy: 'Մաս-կանխիկ վաճառքի համար — օր. մնացածը փոխանցմամբ կամ ուղիղ սեյֆ։ Դուրս է դրամարկղից, գումարը չի փոխվում։', ru: 'Для частично наличной продажи — напр. остаток переводом или сразу в сейф. Исключается из кассы; сумма не меняется.' },
  's.nonDrawerWhere': { en: 'Where did that part go?', hy: 'Ո՞ւր գնաց այդ մասը', ru: 'Куда ушла эта часть?' },
  's.nonDrawerBank': { en: 'Bank account (transfer / card)', hy: 'Բանկային հաշիվ (փոխանցում/քարտ)', ru: 'Банковский счёт (перевод/карта)' },
  's.nonDrawerSafe': { en: 'Straight to the safe (not the bank)', hy: 'Ուղիղ սեյֆ (ոչ բանկ)', ru: 'Сразу в сейф (не в банк)' },
  ...
  'sa.cardTracking': { en: 'Card / bank tracking', hy: 'Քարտ / բանկ հաշվառում', ru: 'Карты / банк' },
  'sa.cardSalesAll': { en: 'Card sales (all time)', hy: 'Քարտով վաճառք (ընդհանուր)', ru: 'Продажи картой (всего)' },
  'sa.bankToSafe': { en: 'Bank → safe', hy: 'Բանկ → սեյֆ', ru: 'Банк → сейф' },
  'sa.thisRange': { en: 'this period', hy: 'այս ժամանակահատվածում', ru: 'за период' },
  'sa.cardInBank': { en: 'Card in bank now', hy: 'Քարտի մնացորդ բանկում', ru: 'На карте в банке' },
  'sa.cardTrackingNote': { en: 'Card money still in the bank = all card sales minus what was moved from the bank into the safe. Company-wide, all time.', hy: 'Բանկում մնացած քարտային գումարը = բոլոր քարտային վաճառքները հանած բանկից սեյֆ տեղափոխվածը։ Ընկերության ընդհանուր, ողջ ժամանակ։', ru: 'Деньги по картам в банке = все продажи картой минус перемещённое из банка в сейф. По всей компании, за всё время.' },

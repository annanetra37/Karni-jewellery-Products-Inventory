...
const D: Record<string, Record<Locale, string>> = {
  ...
  'sa.activeHoursHint': { en: 'Average number of hours with a sale on a typical day, weekday by weekday.', hy: 'Վաճառքով ժամերի միջին քանակը սովորական օրում՝ ըստ շաբաթվա օրերի։', ru: 'Среднее число часов с продажей в типичный день, по дням недели.' },

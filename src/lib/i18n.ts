...
const D: Record<string, Record<Locale, string>> = {
  ...
  'sf.sourceDrawer': { en: 'From the drawer (reduces next opening)', hy: 'Դրամարկղից (նվազեցնում է հաջորդ բացումը)', ru: 'Из кассы (уменьшает следующее открытие)' },
  ...
  'sf.sourceHint': { en: 'Only drawer cash is subtracted when reconciling the next shift’s opening.', hy: 'Հաջորդ հերթափոխի բացումը հաշվարկելիս հանվում է միայն դրամարկղի կանխիկը։', ru: 'При сверке открытия следующей смены вычитаются только наличные из кассы.' },
